#!/usr/bin/env bash
set -euxo pipefail
export HOME=/data/xiaochangyi
export TMPDIR=/data/xiaochangyi/tmp
export RAY_TMPDIR=/data/xiaochangyi/ray_tmp
export XDG_CACHE_HOME=/data/xiaochangyi/cache
export HF_HOME=$XDG_CACHE_HOME/huggingface
export HF_DATASETS_CACHE=$XDG_CACHE_HOME/datasets
...
TRAIN_FILE=${TRAIN_FILE:-"/data/xiaochangyi/DAPO_verl/data/think_MATH-lighteval_train-processed.parquet"}
