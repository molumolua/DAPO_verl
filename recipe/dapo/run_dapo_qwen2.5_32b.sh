...
TRAIN_FILE=${TRAIN_FILE:-"/data2/xucaijun/verl/data/think_MATH-lighteval_train-processed.parquet"}
TEST_FILE=${TEST_FILE:-"/data2/xucaijun/verl/data/think_MATH-500-processed.parquet"}
